...
<div class="page">
	...
	<main>
		...
		{#if lang === 'pl'}
			<p class="what">
				Teksty tego wydania są przepisane litera po literze z publicznie dostępnych świadków — ksiąg
				i wydań liturgii z 1962 roku — i skolacjonowane: żadna rozbieżność w samych literach nie
				jest tolerowana, a różnice akcydentalne (interpunkcja, wielkie litery) mają swoje
				rozstrzygnięcia zapisane w aparacie. Świadkowie, aparaty i całe dane wydania są jawne w
				<a
			...
			<p class="what">
				...
				>. Panel słowa wymienia przy każdym wyrazie, kto potwierdził jego rozbiór; „opracowanie” to
				praca własna wydania — glosy, przekłady, noty i rozstrzygnięcia.
			</p>
			<p class="what">
				„Zaakceptowane” przy słowie znaczy: rozbiór zgodny z głosami analizatorów; „do przeglądu” —
				warstwa czeka na weryfikację. Całość pozostaje <strong>wydaniem roboczym</strong> do czasu przeglądu
				przez latynistę; błędy są możliwe, a uwagi mile widziane.
			</p>
		{:else}
			<p class="what">
				...
				recorded rulings in an apparatus. The witnesses, apparatus and all edition data are open in
				the
				<a
					href="https://github.com/scrutabor/scrutabor-corpus"
					target="_blank"
